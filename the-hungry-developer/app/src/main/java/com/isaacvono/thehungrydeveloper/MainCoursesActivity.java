...
public class MainCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dish[] mainCourses = {
                new Dish("Black pepper and chickpea vindaloo", "Hot vindaloo made with pepper", 1099),
                new Dish("Goji berry and cauliflower saldas", "A crisp salad featuing fresh goji berries", 1399),
